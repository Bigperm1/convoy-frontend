...
export default function MapScreen() {
  ...
  const { connected: carConnected } = useConvoyCarPlay({ route: activeRoute, tbt, user: coords, destination, peers, onEnd: endNav, weather, onReportPolice: () => reportAlert('police') });
