...
import { useSettings, getSettings, updateSettings, updateSettings as updateGlobalSettings, getMapMode, getMapModeChoice, mapModeToLegacy, getAvatarMode, setAvatarMode, getSelfMarkerType, getClassColorRaw, getVehicleClass, unitForCountry, getSpeedAlertMode, getRouteColor } from "../../src/settings";
  ...
  return (
    <View style={styles.c}>
      <MapEngine
        ...
        selfClassColor={getClassColorRaw(settings)}
