...
export const CLASS_LAYERS: Record<string, { priBlack: any; priMask: any; secBlack: any; secMask: any }> = {
  ...
  muscle: { priBlack: L(require("../assets/images/classes/muscle_priblack.png")), priMask: L(require("../assets/images/classes/muscle_primask.png")), secBlack: L(require("../assets/images/classes/muscle_secblack.png")), secMask: L(require("../assets/images/classes/muscle_secmask.png")) },
  supercar: { priBlack: L(require("../assets/images/classes/supercar_priblack.png")), priMask: L(require("../assets/images/classes/supercar_primask.png")), secBlack: L(require("../assets/images/classes/supercar_secblack.png")), secMask: L(require("../assets/images/classes/supercar_secmask.png")) },
  ...
  electric: { priBlack: L(require("../assets/images/classes/electric_priblack.png")), priMask: L(require("../assets/images/classes/electric_primask.png")), secBlack: L(require("../assets/images/classes/electric_secblack.png")), secMask: L(require("../assets/images/classes/electric_secmask.png")) },
