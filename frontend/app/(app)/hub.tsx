...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 15, paddingVertical: 9, borderRadius: 10, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)", backgroundColor: "rgba(255,255,255,0.06)" },
  ...
  heroCta: { paddingHorizontal: 18, paddingVertical: 10, borderRadius: 10 },
  ...
  standTog: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 7, borderWidth: 1, borderColor: "rgba(255,255,255,0.12)" },
  ...
  boardToggle: { flexDirection: "row", backgroundColor: "rgba(118,118,128,0.20)", borderRadius: 7, padding: 2 },
  boardTab: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 6 },
  ...
  clubTag: { backgroundColor: "rgba(255,255,255,0.08)", borderRadius: 6, paddingHorizontal: 10, paddingVertical: 5 },
  clubTagText: { color: "#D8D8DC", fontSize: 11, fontWeight: "600" },

  joinBtn: { backgroundColor: "rgba(255,255,255,0.12)", paddingHorizontal: 16, paddingVertical: 8, borderRadius: 7 },
  joinBtnText: { color: "#06281A", fontWeight: "800", fontSize: 13 },
  joinedPill: { backgroundColor: COLORS.success + "33", paddingHorizontal: 12, paddingVertical: 7, borderRadius: 7 },
  joinedPillText: { color: COLORS.success, fontWeight: "700", fontSize: 12 },
  pendingPill: { backgroundColor: COLORS.warning + "33", paddingHorizontal: 12, paddingVertical: 7, borderRadius: 7 },
  ...
  tagChip: { backgroundColor: "rgba(118,118,128,0.20)", borderRadius: 8, paddingHorizontal: 12, paddingVertical: 7, borderWidth: 1, borderColor: "transparent" },
