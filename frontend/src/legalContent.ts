...
export const PRIVACY_POLICY: { title: string; updated: string; intro: string; sections: LegalSection[] } = {
  ...
  updated: "—",
  intro: "Hairpin (“we”, “us”) built this app for driving together in a group. This policy explains what we collect, why, and the choices you have. Replace this placeholder with your finalized policy.",
  sections: [
    ...
    { heading: "How We Use Location", body: "Your location powers the live convoy map, turn-by-turn navigation, and the CarPlay map. It is only shared inside clubs you’ve joined — never with strangers outside your crew. [Placeholder.]" },
    { heading: "Sign in with Apple & Google", body: "When you sign in with Apple or Google we receive a verified identifier and (if you allow it) your email, used only to create and secure your Hairpin account. [Placeholder.]" },
