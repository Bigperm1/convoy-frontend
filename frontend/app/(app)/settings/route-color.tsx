...
// The original ten, unchanged — whatever a tester already picked keeps its swatch.
const PRESETS: Swatch[] = [
  ...
  { name: "Red", hex: "#FF3B30" }, { name: "Orange", hex: "#FF9500" }, { name: "Yellow", hex: "#FFD60A" },
...
// (CIEDE2000, tools in the 2026-09-23 session): ≥ 10.7 from every other swatch here and from all ten presets, ≥ 22
...
export default function RouteColorPage() {
  ...
  const named = ALL.find((s) => s.hex.toLowerCase() === current)?.name ?? "Custom";
