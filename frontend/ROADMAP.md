...
- ✅ **OTA-X BUILT + SIM-VERIFIED 2026-09-05 11:40 PDT — standalone mitigation for the locked-phone timer freeze. AWAITING JEFF'S GO
  to publish** (Jeff: "ship W build X"). What ships: (1) `src/timerLiveness.ts` — 1 s heartbeat → `timersStarvedMs()`, rAF frame
...
- 🔎 **2026-09-05 07:30 PDT — drives read (Jeff: "lets see the drives from yesterday and today first").** Jeff 09-04: 08:30–09:46
  ...
  embedded bundle (CarPlay-first launch), gets no OTA**. → **OTA-X (built 11:40, awaiting go — entry above):** timer-liveness
