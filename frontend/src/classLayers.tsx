...
export const CLASS_LAYERS: Record<string, { priBlack: any; priMask: any; secBlack: any; secMask: any }> = {
  ...
  jeep: { priBlack: L(require("../assets/images/classes-v2/jeep_priblack.png")), priMask: L(require("../assets/images/classes-v2/jeep_primask.png")), secBlack: L(require("../assets/images/classes-v2/jeep_secblack.png")), secMask: L(require("../assets/images/classes-v2/jeep_secmask.png")) },
