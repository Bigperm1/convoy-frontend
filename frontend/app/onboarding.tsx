...
const styles = StyleSheet.create({
  ...
  skip: { color: '#ddd', fontSize: 14, fontWeight: '500' },
  scroller: { flex: 1 },
  slide: { flex: 1, justifyContent: 'flex-end' },
  image: { ...StyleSheet.absoluteFillObject },
  gradient: { ...StyleSheet.absoluteFillObject },
  content: { paddingHorizontal: 24, paddingBottom: 180 },
  title: { color: '#fff', fontSize: 34, fontWeight: '800', marginBottom: 12, lineHeight: 40 },
  description: { color: '#ddd', fontSize: 16, lineHeight: 24 },
